...
module.exports = function(store) {
  ...
  it(
    'should set and get non-western text',
    co.wrap(function*() {
  ...
  it(
    'should handle non-existent session ids',
    co.wrap(function*() {
  ...
  it(
    'should handle lots of requests at once',
    co.wrap(function*() {
  ...
  it(
    'should handle requests where ttl is in the cookie property',
    co.wrap(function*() {
  ...
  it(
    'should handle requests with undefined ttl',
    co.wrap(function*() {
  ...
  it(
    'should handle requests with null ttl',
    co.wrap(function*() {
      sess.should.not.have.property('cookie');
  ...
  it(
    'should handle requests with 0 ttl',
    co.wrap(function*() {
      sess.should.not.have.property('cookie');
